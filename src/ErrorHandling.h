...
typedef enum
{
    ...
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_BYTE,
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_DOUBLE,
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_INTEGER,
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_POSITION,
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_REAL,
    SUBCODE_FAIL_ADD_SERVICE_READ_VAR_STRING,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_BYTE,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_DOUBLE,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_INTEGER,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_POSITION,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_REAL,
    SUBCODE_FAIL_ADD_SERVICE_WRITE_VAR_STRING,
    ...
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_BYTE,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_BYTE,
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_DOUBLE,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_DOUBLE,
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_INTEGER,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_INTEGER,
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_POSITION,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_POSITION,
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_REAL,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_REAL,
    SUBCODE_FAIL_INIT_SERVICE_READ_VAR_STRING,
    SUBCODE_FAIL_INIT_SERVICE_WRITE_VAR_STRING,
    ...
    SUBCODE_FAIL_CREATE_VAR_EXECUTOR,
